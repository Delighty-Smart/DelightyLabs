...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0c0e12] text-zinc-100 font-sans flex flex-col selection:bg-[#ccff00] selection:text-[#0b0d12]">
      {/* Top Header Navbar matching Google Labs design */}
      <TopNavbar onOpenSettings={() => setSettingsOpen(true)} />

      {/* Main Content Area — Landing page is the default */}
          ...
          <div className="relative w-full max-w-sm bg-[#131620] border border-zinc-800 rounded-3xl p-6 shadow-2xl z-10 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-center justify-between p-2.5 rounded-xl bg-zinc-900 border border-zinc-800">
                ...
                <span className="font-semibold text-blue-400">Dark (Default)</span>
              </div>
              <div className="flex items-center justify-between p-2.5 rounded-xl bg-zinc-900 border border-zinc-800">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-[#131620] border border-zinc-800 rounded-3xl p-6 shadow-2xl z-10 space-y-4">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              Use your API key to connect external MCP clients and launcher scripts to DelightyLabs.
            </p>
