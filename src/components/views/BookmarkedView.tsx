    ...
    <div className="w-full max-w-7xl mx-auto space-y-6 pb-16">
      <div className="flex items-center justify-between pb-4 border-b border-zinc-800">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold text-white tracking-tight">Saved Apps Directory</h1>
          ...
          <p className="text-xs sm:text-sm text-zinc-400 mt-1">
            Published applications you have pinned to your personal hub for quick access and launch.
          </p>
        </div>
      ...
      {!user ? (
        <div className="py-16 text-center rounded-3xl bg-zinc-900/40 border border-zinc-800 space-y-4">
          ...
          <h3 className="text-base font-semibold text-white">Sign in to save apps to your testbench</h3>
          <p className="text-xs text-zinc-400 max-w-md mx-auto">
            Create an account to pin experimental apps, track testing progress, and earn testing bounties.
          </p>
          <button
        ...
        <div className="py-16 text-center rounded-3xl bg-zinc-900/40 border border-zinc-800 space-y-4">
          <Bookmark className="w-12 h-12 text-zinc-500 mx-auto" />
          <h3 className="text-base font-semibold text-white">Your testbench is empty</h3>
          <p className="text-xs text-zinc-400 max-w-md mx-auto">
            Click the bookmark icon on any beta app card in the Gallery to pin it here for quick access.
          </p>
          <button
            onClick={() => setActiveNav('gallery')}
